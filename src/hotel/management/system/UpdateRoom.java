...
public class UpdateRoom extends JFrame implements ActionListener{
    ...
    UpdateRoom(){
        ...
        add(b3);
        ImageIcon mi = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/seventh.jpg"));
        Image m1 =mi.getImage().getScaledInstance(500,300,Image.SCALE_DEFAULT);
        ImageIcon m2 = new ImageIcon(m1);
        JLabel l9 =new JLabel(m2);
        ...
        if(ae.getSource()==b1){
            ...
            try{
               ResultSet rs =c.s.executeQuery("select * from customer where number ='"+s1+"'");
                ...
                ResultSet rs2 =c.s.executeQuery("select * from room where room_no ='"+room_number+"'");
                while(rs2.next()){
            ...
            try{
                ...
                String sr="Update room set available ='"+available+"',status = '"+status+"'where room_no ='"+room_number+"'";
